        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Fees Paid Search</h4>
              ...
              <thead>
                                    <tr>
                                        ...
                                        <th>Fees Payment ID</th>
                                        <th>Fees Gateway ID</th>
                                         <th>Fees Type</th>
                  ...
                  <?php
                 $queryToSelect="select * from admission_fees_transactions where fees_status='Credit'";
