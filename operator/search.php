                            ...
                            <table class="table table-striped table-bordered file-export">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="updateUser/<%=users[i]._id %>" class="btn btn-warning fa fa-edit">Update</a></td>
                                     <td><a href="delete/<%=users[i]._id %>" data-id="<%=users[i]._id %>" class="btn btn-danger fa fa-trash">Delete</a></td>
                                  </tr>    
                                 <% } %>
                                </tbody>
