                ...
                <div class="card-body">
                  <form class="form-horizontal" action="" method="post">
                    <fieldset class="form-group position-relative has-icon-left">
                      <select name="admin_role" class="form-control round" required="">
                    ...
                    <fieldset class="form-group position-relative has-icon-left">
                      <input name="admin_email" type="email" class="form-control round" id="user-email" placeholder="Email Address" required>
                      <div class="form-control-position">
                        <i class="ft-mail"></i>
                      </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group position-relative has-icon-left">
                      <input name="admin_mobile" type="number" class="form-control round" id="user-phone" placeholder="Enter Mobile Number" required>
                      <div class="form-control-position">
                        <i class="ft-phone"></i>
                      </div>
                    </fieldset>
