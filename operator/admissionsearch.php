        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Search Student and Faculty Records</h4>
              ...
              <thead>
                                    <tr>
                                         ...
                                         <th>Academic Year</th>
                                         <th>Cast</th>
                                         <th>Account Created Datetime</th>

                                    </tr>
                                </thead>
                  <?php
                 $queryToSelect="select * from users";
       ...
       ?>     
                                ...
                                <?php
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $row['user_prn'];?></td>
                                    <td><?php echo $row['user_rfid'];?></td>
                                    <td><?php echo $row['user_branch'];?></td>
                                    <td><?php echo $row['user_year'];?></td>
                                     
                                    <td><?php echo $row['user_acad_year'];?></td>
                                     <td><?php echo $row['user_cast'];?></td>
                                     <td><?php echo $row['user_acc_created_datetime'];?></td>
