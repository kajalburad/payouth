    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Pay Fees For Old Students</h4>
            ...
            <form class="form form-horizontal" method="post">
              ...
              <div class="form-actions center">
                              <button type="submit" class="btn btn-primary" name="save">
                                  <i class="la la-check-square-o" ></i> Pay Fees
                              </button>
                          </div>
            </form>
                  </div>
...
$type="text"; 
//$_SESSION['ottp']=$otp;
$n1="Dear student please click on following link to complete payment:".$successdata['longurl'] ;	// actual message content
