        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse show" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">         
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">             <span class="avatar avatar-online"><img src="app-assets/images/users/student.png" alt="avatar"></span></a>
                <div class="dropdown-menu dropdown-menu-right">
                  <div class="arrow_box_right"><a class="dropdown-item" href="#"><span class="avatar avatar-online"><img src="app-assets/images/users/student.png" alt="avatar"><span class="user-name text-bold-700 ml-1"><?php echo $mail;?></span></span></a>
                    <div class="dropdown-divider"></div><a class="dropdown-item" href="showqr.php"><i class="ft-user"></i>View QR Code</a>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="app-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="addmoney.php"><i class="ft-plus-circle"></i><span class="menu-title" data-i18n=""> Add Money</span></a></li>
               ...
               <li class=" nav-item"><a href="sendmoney.php"><i class="ft-bell"></i><span class="menu-title" data-i18n="">Send Money</span></a>
              ...
              <li><a class="menu-item" href="walletpaid.php">Successful Transaction</a>
              </li>
              <li><a class="menu-item" href="walletunpaid.php">Failed Transactions</a>
              </li>
                         </ul>
